...
class HeraldedCircuit_FREE_LD:
    def __init__(self, circuit: stim.Circuit, biased_erasure: bool, cycles: int, phys_error:float, erasure_ratio:float, ancilla_qubits:list, data_qubits:list, loss_detection_freq=None, code=None, basis = None, SSR = True, printing=False, **kwargs) -> None:
