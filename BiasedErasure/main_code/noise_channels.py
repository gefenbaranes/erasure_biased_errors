...
class Noise:
    ...
    def biased_erasure_noise_old(self, phys_err, bias_ratio, erasure_ratio):
    ...
    def biased_erasure_noise(self, phys_err, bias_ratio):
    ...
    def biased_erasure_noise_MBQC(self, 
    ...
    def entangling_error(self, instruction, circuit: stim.Circuit, entangling_gate_error_rate, entangling_gate_loss_rate, erasure_weight,
    ...
    def biased_erasure_noise_correlated(self):
    ...
    def apply_noise(self, noise_type, *args, **kwargs):
        if noise_type == 'biased_erasure_noise':
            return self.biased_erasure_noise(*args, **kwargs)
        elif noise_type == 'biased_erasure_noise_MBQC':
            return self.biased_erasure_noise_MBQC(*args, **kwargs)
        elif noise_type == 'no_noise':
            return self.no_noise()
        elif noise_type == 'atom_array':
