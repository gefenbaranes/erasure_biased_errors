...
errors = np.array([0.16, 0.202, 0.234, 0.292, 0.322, 0.35, 0.384, 0.393, 0.426, 0.429, 0.47])
#errors = errors / 3 * num_cxs
errors_per_rounds = .5*(1-(1-errors/.5)**(1/(3*num_cxs)))
errors_per_rounds_division = errors / (3*num_cxs)
plt.plot(num_cxs, errors_per_rounds, marker='o', color='blue', label='1 error correction round')
plt.plot(num_cxs, errors_per_rounds_division, marker='o', color='red', label='divide by # rounds')
